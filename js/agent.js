      ...
      <div class="p-4 rounded-2xl border ${cardBorder} hover:border-fiber-500/50 transition-all shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div class="flex items-start gap-3.5">
            ...
            <div>
              ...
              <div class="flex items-center gap-3 mt-1.5">
                <a href="tel:${escHtml(c.cellNumber)}" class="inline-flex items-center gap-1.5 text-sm font-semibold font-mono text-fiber-400 hover:text-fiber-300 transition-colors">
                  <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                  </svg>
                  ${escHtml(c.cellNumber || 'No number')}
                </a>
                <button onclick="copyPhone('${escJs(c.cellNumber)}')" title="Copy Phone Number" class="p-1 text-gray-500 hover:text-gray-300 transition-colors">
          ...
          <div class="flex items-center gap-2.5 sm:self-center">
            <a href="tel:${escHtml(c.cellNumber)}" class="px-3.5 py-2 rounded-xl text-xs font-bold bg-white/5 hover:bg-white/10 text-white border border-white/10 transition-colors flex items-center gap-1.5">
              📞 Call Now
            </a>
